...
class Metaclass_NavigateToPose_Goal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('ros2_nav_to_pose_msgs')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'ros2_nav_to_pose_msgs.action.NavigateToPose_Goal')
            logger.debug(
...
class Metaclass_NavigateToPose_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'ros2_nav_to_pose_msgs.action.NavigateToPose_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_NavigateToPose_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'ros2_nav_to_pose_msgs.action.NavigateToPose_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class NavigateToPose_Feedback(metaclass=Metaclass_NavigateToPose_Feedback):
    ...
    __slots__ = [
        '_remaining_distance_to_goal',
        '_check_fields',
    ]

    _fields_and_field_types = {
        'remaining_distance_to_goal': 'double',
    }
    ...
    def __init__(self, **kwargs):
        ...
        if self._check_fields:
            assert all('_' + key in self.__slots__ for key in kwargs.keys()), \
                'Invalid arguments passed to constructor: %s' % \
                ', '.join(sorted(k for k in kwargs.keys() if '_' + k not in self.__slots__))
        self.remaining_distance_to_goal = kwargs.get('remaining_distance_to_goal', float())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.remaining_distance_to_goal != other.remaining_distance_to_goal:
            return False
        return True
    ...
    @builtins.property
    def remaining_distance_to_goal(self):
        """Message field 'remaining_distance_to_goal'."""
        return self._remaining_distance_to_goal

    @remaining_distance_to_goal.setter
    def remaining_distance_to_goal(self, value):
        if self._check_fields:
            assert \
                isinstance(value, float), \
                "The 'remaining_distance_to_goal' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'remaining_distance_to_goal' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._remaining_distance_to_goal = value
...
class NavigateToPose_SendGoal_Request(metaclass=Metaclass_NavigateToPose_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'ros2_nav_to_pose_msgs/NavigateToPose_Goal',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['ros2_nav_to_pose_msgs', 'action'], 'NavigateToPose_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from ros2_nav_to_pose_msgs.action._navigate_to_pose import NavigateToPose_Goal
...
class NavigateToPose_SendGoal_Event(metaclass=Metaclass_NavigateToPose_SendGoal_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<ros2_nav_to_pose_msgs/NavigateToPose_SendGoal_Request, 1>',
        'response': 'sequence<ros2_nav_to_pose_msgs/NavigateToPose_SendGoal_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['ros2_nav_to_pose_msgs', 'action'], 'NavigateToPose_SendGoal_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['ros2_nav_to_pose_msgs', 'action'], 'NavigateToPose_SendGoal_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from ros2_nav_to_pose_msgs.action import NavigateToPose_SendGoal_Request
    ...
    def response(self, value):
        if self._check_fields:
            from ros2_nav_to_pose_msgs.action import NavigateToPose_SendGoal_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_NavigateToPose_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'ros2_nav_to_pose_msgs.action.NavigateToPose_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from ros2_nav_to_pose_msgs.action import _navigate_to_pose
...
class NavigateToPose_SendGoal(metaclass=Metaclass_NavigateToPose_SendGoal):
    from ros2_nav_to_pose_msgs.action._navigate_to_pose import NavigateToPose_SendGoal_Request as Request
    from ros2_nav_to_pose_msgs.action._navigate_to_pose import NavigateToPose_SendGoal_Response as Response
    from ros2_nav_to_pose_msgs.action._navigate_to_pose import NavigateToPose_SendGoal_Event as Event
...
class NavigateToPose_GetResult_Response(metaclass=Metaclass_NavigateToPose_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'ros2_nav_to_pose_msgs/NavigateToPose_Result',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['ros2_nav_to_pose_msgs', 'action'], 'NavigateToPose_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from ros2_nav_to_pose_msgs.action._navigate_to_pose import NavigateToPose_Result
...
class NavigateToPose_GetResult_Event(metaclass=Metaclass_NavigateToPose_GetResult_Event):
    ...
    _fields_and_field_types = {
        'info': 'service_msgs/ServiceEventInfo',
        'request': 'sequence<ros2_nav_to_pose_msgs/NavigateToPose_GetResult_Request, 1>',
        'response': 'sequence<ros2_nav_to_pose_msgs/NavigateToPose_GetResult_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['service_msgs', 'msg'], 'ServiceEventInfo'),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['ros2_nav_to_pose_msgs', 'action'], 'NavigateToPose_GetResult_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['ros2_nav_to_pose_msgs', 'action'], 'NavigateToPose_GetResult_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from ros2_nav_to_pose_msgs.action import NavigateToPose_GetResult_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
    ...
    def response(self, value):
        if self._check_fields:
            from ros2_nav_to_pose_msgs.action import NavigateToPose_GetResult_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_NavigateToPose_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'ros2_nav_to_pose_msgs.action.NavigateToPose_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class NavigateToPose_GetResult(metaclass=Metaclass_NavigateToPose_GetResult):
    from ros2_nav_to_pose_msgs.action._navigate_to_pose import NavigateToPose_GetResult_Request as Request
    from ros2_nav_to_pose_msgs.action._navigate_to_pose import NavigateToPose_GetResult_Response as Response
    from ros2_nav_to_pose_msgs.action._navigate_to_pose import NavigateToPose_GetResult_Event as Event
...
class Metaclass_NavigateToPose_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'ros2_nav_to_pose_msgs.action.NavigateToPose_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class NavigateToPose_FeedbackMessage(metaclass=Metaclass_NavigateToPose_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'ros2_nav_to_pose_msgs/NavigateToPose_Feedback',
    }
    ...
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['ros2_nav_to_pose_msgs', 'action'], 'NavigateToPose_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from ros2_nav_to_pose_msgs.action._navigate_to_pose import NavigateToPose_Feedback
...
class Metaclass_NavigateToPose(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'ros2_nav_to_pose_msgs.action.NavigateToPose')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class NavigateToPose(metaclass=Metaclass_NavigateToPose):
    ...
    from ros2_nav_to_pose_msgs.action._navigate_to_pose import NavigateToPose_Goal as Goal
    # The result message defined in the action definition.
    from ros2_nav_to_pose_msgs.action._navigate_to_pose import NavigateToPose_Result as Result
    # The feedback message defined in the action definition.
    from ros2_nav_to_pose_msgs.action._navigate_to_pose import NavigateToPose_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from ros2_nav_to_pose_msgs.action._navigate_to_pose import NavigateToPose_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from ros2_nav_to_pose_msgs.action._navigate_to_pose import NavigateToPose_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from ros2_nav_to_pose_msgs.action._navigate_to_pose import NavigateToPose_FeedbackMessage as FeedbackMessage
