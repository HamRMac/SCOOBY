...
class Metaclass_StateMachine(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from yasmin_msgs.msg import State
...
class StateMachine(metaclass=Metaclass_StateMachine):
    ...
    _fields_and_field_types = {
        'states': 'sequence<yasmin_msgs/State>',
    }

    # This attribute is used to store an rosidl_parser.definition variable
    # related to the data type of each of the components the message.
    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['yasmin_msgs', 'msg'], 'State')),  # noqa: E501
    )
        ...
        if self._check_fields:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'states' field must be a set or sequence and each value of type 'State'"
        self._states = value
