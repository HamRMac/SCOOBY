...
#include "yasmin_msgs/msg/detail/state__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const yasmin_msgs::msg::Transition &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  yasmin_msgs::msg::Transition &);
...
cdr_serialize(
  const yasmin_msgs::msg::State & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  yasmin_msgs::msg::State & ros_message)
{
  // Member: id
  cdr >> ros_message.id;
  ...
  size_t current_alignment)
{
  ...
  // Member: transitions
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        yasmin_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Transition(
  ...
  if (is_plain) {
    ...
    using DataType = yasmin_msgs::msg::State;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: transitions
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; i++) {
      yasmin_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize_key(
        ros_message.transitions[i],
        cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: transitions
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        yasmin_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size_key(
        ros_message.transitions[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: transitions
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        yasmin_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_Transition(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const yasmin_msgs::msg::State *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<yasmin_msgs::msg::State *>(
    untyped_ros_message);
...
{
  return &yasmin_msgs::msg::typesupport_fastrtps_cpp::_State__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, yasmin_msgs, msg, State)() {
  return &yasmin_msgs::msg::typesupport_fastrtps_cpp::_State__handle;
}
