...
// IWYU pragma: private, include "yasmin_msgs/msg/state.h"


#ifndef YASMIN_MSGS__MSG__DETAIL__STATE__FUNCTIONS_H_
#define YASMIN_MSGS__MSG__DETAIL__STATE__FUNCTIONS_H_
 ...
 * calls
 * yasmin_msgs__msg__State__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_yasmin_msgs
yasmin_msgs__msg__State *
yasmin_msgs__msg__State__create(void);

/// Destroy msg/State message.
/**
 * It calls
 * yasmin_msgs__msg__State__fini()
 ...
 * yasmin_msgs__msg__State__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * yasmin_msgs__msg__State__Sequence__fini()
 * on the array,
...
#endif  // YASMIN_MSGS__MSG__DETAIL__STATE__FUNCTIONS_H_
