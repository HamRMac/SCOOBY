...
#include "yasmin_msgs/msg/detail/transition__type_support.h"
...
static const _Transition_type_support_symbol_names_t _Transition_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, yasmin_msgs, msg, Transition)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, yasmin_msgs, msg, Transition)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, yasmin_msgs, msg, Transition)() {
  return &::yasmin_msgs::msg::rosidl_typesupport_c::Transition_message_type_support_handle;
}
