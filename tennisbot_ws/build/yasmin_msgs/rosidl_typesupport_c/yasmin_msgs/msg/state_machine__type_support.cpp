...
#include "yasmin_msgs/msg/detail/state_machine__type_support.h"
...
static const _StateMachine_type_support_symbol_names_t _StateMachine_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, yasmin_msgs, msg, StateMachine)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, yasmin_msgs, msg, StateMachine)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, yasmin_msgs, msg, StateMachine)() {
  return &::yasmin_msgs::msg::rosidl_typesupport_c::StateMachine_message_type_support_handle;
}
