...
static const _Transition_type_support_symbol_names_t _Transition_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, yasmin_msgs, msg, Transition)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, yasmin_msgs, msg, Transition)),
  }
};
...
{
  return &::yasmin_msgs::msg::rosidl_typesupport_cpp::Transition_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, yasmin_msgs, msg, Transition)() {
  return get_message_type_support_handle<yasmin_msgs::msg::Transition>();
}
